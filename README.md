...
- 🛡️ **No accidental exits** — the video body belongs to the room: clicking it toggles play/pause, like any player, instead of falling through to YouTube's title bar, paused-screen suggestions or creators' end-screen links, all of which open youtube.com over your sesh. YouTube's own control bar (pause, seek, volume, captions) stays fully usable — and the "Up next" promise is clickable everywhere it appears, over the video or in the panel, to skip straight to it
