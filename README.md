...
- 🛡️ **No accidental exits** — the video body belongs to the room: clicking it toggles play/pause, like any player, instead of falling through to YouTube's title bar, paused-screen suggestions or creators' end-screen links, all of which open youtube.com over your sesh. What YouTube draws for *you* stays YouTube's and stays clickable — the scrubber, and volume, captions and quality in the top-right corner — while the row below the scrubber, which is nothing but "More videos" and "Watch on YouTube", doesn't. Nothing of ours is drawn over the picture either: what's coming up lives in the panel under the player, where it doesn't compete with the film
